...
class HomeBasicAdapter: RecyclerView.Adapter<HomeBasicViewHolder>() {
    ...
    var items: ArrayList<String> = arrayListOf("Первая рубрика", "Вторая рубрика","Третья рубрика", "Четвертая рубрика")
    ...
    override fun onBindViewHolder(holder: HomeBasicViewHolder, position: Int) {
        ...
        holder.basicContent.text = "Тут будут карточки фильмов"
    }
