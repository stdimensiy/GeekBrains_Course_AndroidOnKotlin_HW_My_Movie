...
object TMDBAPIConstants {
    ...
    /** API KEY  V3 */
    val API_KEY_V3 = "aefbe34a550ff3229e1b71c60f4f16d0"
    ...
    val TEMP_POPULAR_MOVIE = "https://api.themoviedb.org/3/movie/popular?api_key=aefbe34a550ff3229e1b71c60f4f16df&language&language=ru-RU"
    /** временно полный запрос к конфигурацилнным данным */
    val TEMP_GETCONFIGURAT = "https://api.themoviedb.org/3/configuration?api_key=aefbe34a550ff3229e1b71c60f4f16df&language"
}